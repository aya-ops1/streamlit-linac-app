# app_linac_pred_authenticated.py
...
st.markdown(
    ...
    "Bienvenue sur l'outil de prédiction du risque de panne LINAC développé par SCRIM. Chargez votre historique d’interventions ; l’IA prédit les pannes dans les 15 jours "
...
def pipeline(df_raw: pd.DataFrame):
    ...
    X_tr, X_te, y_tr, y_te = train_test_split(X, y, stratify=y, test_size=0.30, random_state=42)
